...
router.route('/store/cover').post(merchantAuth, merchantController.uploadStoreCover)
router.route('/store/logo').post(merchantAuth, merchantController.uploadStoreLogo)
